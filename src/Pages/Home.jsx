        ...
        <main className="flex-grow">
          ...
          <section className="bg-gradient-to-b from-green-50 to-white py-20 text-center">
            ...
            <p className="mt-4 text-gray-700 max-w-2xl mx-auto">
              Join ReWear's community-driven clothing exchange. Swap, redeem,
              and discover pre-loved fashion while making a positive impact on
              the environment.
            </p>
            <div className="mt-6 flex justify-center gap-4">
              ...
              <a
                href="/browse"
                className="text-black border border-gray-300 px-6 py-3 rounded-md text-sm font-semibold hover:bg-gray-100 transition"
              >
                Browse Items
              </a>
            </div>
